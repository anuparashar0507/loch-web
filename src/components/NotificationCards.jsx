...
const NotificationCards = () => {
  return (
    <div className="flex flex-row gap-4 max-w-[380px] overflow-hidden">
      <div className="p-3.5 rounded-xl  max-w-[190px] gap-4 max-h-[172px] bg-white shadow-[0px_1px_1px_0px_rgba(0, 0, 0, 0.04), 0px_4px_10px_0px_rgba(0, 0, 0, 0.04)]">
      ...
      <div className="p-3.5 rounded-xl min-w-[190px] gap-4 max-h-[172px] bg-white shadow-[0px_1px_1px_0px_rgba(0, 0, 0, 0.04), 0px_4px_10px_0px_rgba(0, 0, 0, 0.04)]">
        <div className="flex flex-col w-full gap-[14px] justify-stretch">
          <div className="flex row-span-1 justify-between items-start">
